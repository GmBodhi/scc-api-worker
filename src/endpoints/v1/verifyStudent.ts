...
export class VerifyStudent extends OpenAPIRoute {
  ...
  async handle(c: AppContext) {
    ...
    try {
      ...
      const matchingStudentResult = await c.env.EVENTS_DB.prepare(
      ...
      const emailExistsResult = await c.env.EVENTS_DB.prepare(
      ...
      const phoneExistsResult = await c.env.EVENTS_DB.prepare(
